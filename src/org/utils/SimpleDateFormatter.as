class org.utils.SimpleDateFormatter
{
   ...
   static function getDateFromFormat(val, format, language)
   {
      ...
      while(true)
      {
         if(_loc6_ >= format.length)
         {
            ...
            _loc25_ = new Date(_loc13_,_loc14_ - 1,_loc15_,_loc16_,_loc17_,_loc18_,_loc19_);
            return _loc25_;
         }
         _loc7_ = format.charAt(_loc6_);
         _loc8_ = "";
         ...
         else if(_loc8_ == "MMM" || _loc8_ == "NNN")
         {
            ...
            {
               _loc22_ = org.utils.SimpleDateFormatter.MONTH_NAMES[language][_loc21_];
         ...
         else if(_loc8_ == "EE" || _loc8_ == "E")
         {
            ...
            {
               _loc24_ = org.utils.SimpleDateFormatter.DAY_NAMES[language][_loc23_];
   ...
   static function _getInt(str, i, minlength, maxlength)
   {
      ...
      {
         _loc7_ = str.substring(i,i + _loc6_);
