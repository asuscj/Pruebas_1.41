class ank.gapi.core.UIBasicComponent extends ank.utils.QueueEmbedMovieClip
{
   ...
   function drawRoundRect(mc, x, y, w, h, r, c, alpha, rot, gradient, ratios)
   {
      ...
      if(typeof c == "object")
      {
         ...
         {
            _loc19_ = {matrixType:"box",x:- _loc18_,y:_loc18_,w:w * 2,h:h * 4,r:rot * 0.0174532925199433};
         }
         else
         {
            _loc19_ = rot;
      ...
      if(r != 0)
      {
         _loc20_ = r - r * 0.707106781186547;
         _loc21_ = r - r * 0.414213562373095;
         mc.moveTo(x + w,y + h - r);
         mc.lineTo(x + w,y + h - r);
      ...
      if(r != 0)
      {
         _loc22_ = r - r * 0.707106781186547;
         _loc23_ = r - r * 0.414213562373095;
         mc.lineTo(x + r,y + h);
      ...
      if(r != 0)
      {
         _loc24_ = r - r * 0.707106781186547;
         _loc25_ = r - r * 0.414213562373095;
         mc.lineTo(x,y + r);
      ...
      if(r != 0)
      {
         _loc26_ = r - r * 0.707106781186547;
         _loc27_ = r - r * 0.414213562373095;
         mc.lineTo(x + w - r,y);
