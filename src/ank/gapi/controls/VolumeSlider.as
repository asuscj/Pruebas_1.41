class ank.gapi.controls.VolumeSlider extends ank.gapi.core.UIBasicComponent
{
   ...
   function set value(nValue)
   {
      ...
      {
         _loc3_ = Math.floor((this._nMarkerCount - 1) * (nValue - this._nMin) / (this._nMax - this._nMin));
   ...
   function arrange()
   {
      ...
      {
         _loc7_ = this._mcMarkers["mcMarker" + _loc6_];
         _loc8_ = this._mcOvers["mcOver" + _loc6_];
         _loc9_ = _loc8_.index;
         _loc10_ = _loc9_ / this._nMarkerCount;
   ...
   function createMarkers()
   {
      ...
      {
         _loc3_ = this._mcMarkers.attachMovie(this._sMarkerSkin,"mcMarker" + _loc2_,_loc2_);
         _loc4_ = this._mcOvers.createEmptyMovieClip("mcOver" + _loc2_,_loc2_);
