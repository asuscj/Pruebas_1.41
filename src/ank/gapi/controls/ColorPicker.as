class ank.gapi.controls.ColorPicker extends ank.gapi.core.UIBasicComponent
{
   ...
   function getGradientColor()
   {
      ...
      if(_loc7_ != _loc10_)
      {
         _loc13_ = Math.round(_loc7_ <= _loc10_ ? _loc4_ : 255 - _loc4_);
      }
      else
      {
         _loc13_ = _loc7_ >> 16;
      ...
      if(_loc8_ != _loc11_)
      {
         _loc14_ = Math.round(_loc8_ <= _loc11_ ? _loc4_ : 255 - _loc4_);
      }
      else
      {
         _loc14_ = _loc8_ >> 8;
      ...
      if(_loc9_ != _loc12_)
      {
         _loc15_ = Math.round(_loc9_ <= _loc12_ ? _loc4_ : 255 - _loc4_);
      }
      else
      {
         _loc15_ = _loc9_;
