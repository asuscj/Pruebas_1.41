   ...
   function onLoadInit(mc)
   {
      ...
      switch(displayType)
      {
         ...
         case 21:
            ...
            mc._y = _loc12_.y;
            _loc14_ = Math.PI / 2;
            _loc15_ = _loc13_.x - _loc12_.x;
            _loc16_ = _loc13_.y - _loc12_.y;
            mc.rotate._rotation = mc.angle;
            _loc17_ = mc.attachMovie("shoot","shoot",10);
            _loc17_._x = _loc15_;
            _loc17_._y = _loc16_;
            break;
         case 30:
         case 31:
            ...
            mc._y = _loc12_.y - 10;
            mc.level = _loc6_;
            _loc18_ = !(displayType == 31 || displayType == 33) ? 0.5 : 0.9;
            ...
            _loc19_ = Math.PI / 2;
            _loc20_ = _loc13_.x - _loc12_.x;
            _loc21_ = _loc13_.y - _loc12_.y;
            _loc22_ = (Math.atan2(_loc21_,Math.abs(_loc20_)) + _loc19_) * _loc18_;
