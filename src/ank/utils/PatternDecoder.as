      ...
      while(_loc4_ < _loc6_)
      {
         ...
         switch(_loc5_)
         {
            ...
            case "~":
               ...
               break;
            case "{":
               _loc9_ = ank.utils.PatternDecoder.find(aStr.slice(_loc4_),"}");
               _loc10_ = ank.utils.PatternDecoder.decodeDescription(aStr.slice(_loc4_ + 1,_loc4_ + _loc9_),aParams).join("");
               aStr.splice(_loc4_,_loc9_ + 1,_loc10_);
               break;
            case "[":
               _loc11_ = ank.utils.PatternDecoder.find(aStr.slice(_loc4_),"]");
               _loc12_ = Number(aStr.slice(_loc4_ + 1,_loc4_ + _loc11_).join(""));
      ...
      while(_loc4_ < _loc6_)
      {
         ...
         switch(_loc5_)
         {
            case "~":
               ...
               break;
            case "{":
               _loc8_ = ank.utils.PatternDecoder.find(aStr.slice(_loc4_),"}");
               _loc9_ = ank.utils.PatternDecoder.decodeCombine(aStr.slice(_loc4_ + 1,_loc4_ + _loc8_),oParams).join("");
