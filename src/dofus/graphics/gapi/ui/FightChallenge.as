class dofus.graphics.gapi.ui.FightChallenge extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function updateList()
   {
      ...
      {
         _loc2_ = dofus.graphics.gapi.controls.FightChallengeIcon(this.attachMovie("FightChallengeIcon","FightChallengeIcon" + _loc3_,_loc3_ + 1,{challenge:this._aChallengeList[_loc3_]}));
