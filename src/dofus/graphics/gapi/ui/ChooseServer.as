class dofus.graphics.gapi.ui.ChooseServer extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function updateServerList()
   {
      ...
      if(this._eaFavoriteServers.length > 0)
      {
         ...
         while(_loc2_ < 5)
         {
            _loc3_ = this._eaFavoriteServers[_loc2_ + this._nServerStartIndex];
            if(_loc3_ != undefined)
            {
               _loc4_ = this["_css" + _loc2_];
   ...
   function selectServer(nServerID)
   {
      ...
      {
         _loc3_ = this.api.datacenter.Basics.aks_servers.findFirstItem("id",nServerID).item;
         if(_loc3_.state == dofus.datacenter.Server.SERVER_ONLINE)
         {
            _loc4_ = new dofus.datacenter.Server(nServerID,1,0);
   ...
   function click(oEvent)
   {
      ...
      {
         case "_btnSelect":
            _loc3_ = this.gapi.getUIComponent("ServerList");
            if(_loc3_ != undefined)
            {
