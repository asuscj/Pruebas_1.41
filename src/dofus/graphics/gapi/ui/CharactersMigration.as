class dofus.graphics.gapi.ui.CharactersMigration extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function validateCreation(sCharacterName, nCharacterId)
   {
      ...
      {
         _loc4_ = new dofus.utils.nameChecker.NameChecker(sCharacterName);
         _loc5_ = new dofus.utils.nameChecker.rules.NameCheckerCharacterNameRules();
      ...
      if(!this.api.lang.getConfigText("CHARACTER_MIGRATION_ASK_SERVER_CONFIRM"))
      {
         ...
         {
            _loc7_ = {name:"ConfirmMigration",params:{nCharacterId:nCharacterId,sCharacterName:sCharacterName},listener:this};
