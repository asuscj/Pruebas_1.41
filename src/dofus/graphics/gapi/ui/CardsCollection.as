   ...
   function dblClickItem(oEvent)
   {
      ...
      if((_loc0_ = oEvent.owner._name) === "_cgCardsGrid")
      {
         ...
         if(this._sCurrentEntityNameSearch == undefined)
         {
            ...
            {
               _loc4_ = dofus.datacenter.Item(this.api.datacenter.Player.Inventory.findFirstItem("unicID",_loc3_.correspondingItemID).item);
               if(_loc4_ != undefined)
               {
      ...
      switch(oEvent.owner)
      {
         ...
         case this._cgCardsGrid:
            ...
            if(!_loc7_.owned && this._sCurrentEntityNameSearch == undefined)
            {
               ...
               {
                  _loc9_ = dofus.datacenter.Item(this.api.datacenter.Player.Inventory.findFirstItem("unicID",_loc7_.correspondingItemID).item);
                  if(_loc9_ != undefined)
                  {
                     _loc8_ = true;
                  }
            ...
            {
               _loc10_ = new ank.utils.ExtendedDate(_loc7_.ownedTimestamp);
