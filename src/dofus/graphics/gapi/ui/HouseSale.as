      ...
      switch(oEvent.target._name)
      {
         ...
         case "_btnValidate":
            ...
            else
            {
               ...
               {
                  _loc3_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("HOUSE_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_HOUSE",[this._oHouse.name,this.getFormattedPrice()])});
