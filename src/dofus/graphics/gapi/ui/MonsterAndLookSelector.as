class dofus.graphics.gapi.ui.MonsterAndLookSelector extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function loadLooks()
   {
      ...
      _loc2_.onLoad = function()
      {
         ...
         {
            _loc6_ = _loc5_.attributes.name;
            _loc7_ = new ank.utils.ExtendedArray();
            _loc8_ = _loc5_.firstChild;
            while(_loc8_ != undefined)
            {
               _loc9_ = _loc8_.attributes.id;
               _loc10_ = _loc8_.attributes.name;
               _loc11_ = {iconFile:_loc2_ + _loc9_ + ".swf",name:_loc10_,id:_loc9_,gfxId:_loc9_};
               _loc7_.push(_loc11_);
               _loc4_.push(_loc11_);
   ...
   function loadMonsters(sFilter)
   {
      ...
      for(var a in _loc3_)
      {
         ...
         _loc12_ = _loc8_.n;
         _loc13_ = _loc8_.g;
         _loc14_ = {iconFile:_loc4_ + _loc13_ + ".swf",name:_loc12_,id:_loc11_,gfxId:_loc13_};
         _loc6_.push(_loc14_);
   ...
   function filterResult(sFilter)
   {
      ...
      {
         _loc6_ = new ank.utils.ExtendedString(_loc3_[_loc5_].name).removeAccents().toUpperCase();
   ...
   function itemSelected(oEvent)
   {
      ...
      {
         case this._cbType:
            _loc3_ = this._cbType.selectedItem.data;
