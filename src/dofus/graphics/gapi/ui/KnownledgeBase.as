class dofus.graphics.gapi.ui.KnownledgeBase extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function searchTopic(sTopic)
   {
      ...
      {
         _loc11_ = this._eaIndexes[_loc10_];
         _loc12_ = this.searchWordsInName(_loc3_,_loc11_.name,_loc7_);
         if(_loc12_ != 0)
         {
      ...
      while(_loc13_ < _loc6_.length)
      {
         ...
         {
            _loc14_ = this._eaArticles.findFirstItem("i",_loc6_[_loc13_].i).item;
            _loc4_.push(_loc14_);
