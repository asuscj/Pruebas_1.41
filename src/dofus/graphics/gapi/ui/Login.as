class dofus.graphics.gapi.ui.Login extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function refreshAutoLoginUi()
   {
      ...
      {
         _loc3_ = dofus.ZaapConnect.getInstance();
   ...
   function createChildren()
   {
      ...
      {
         _loc2_ = this.api.lang.getConfigText("ALERTY_LINK");
         if(_loc2_ != "")
         {
   ...
   function loadNews()
   {
      ...
      {
         _loc2_ = new ank.utils.rss.RSSLoader();
         ...
         _loc3_ = this.api.lang.getConfigText("RSS_LINK");
         if(_loc3_ != "")
         {
            _loc2_.load(_loc3_);
         }
   ...
   function loadFlags()
   {
      ...
      while(_loc6_ < _loc5_.length)
      {
         ...
         _loc8_ = this.attachMovie("UI_LoginLanguage" + _loc7_.toUpperCase(),"_mcFlag" + _loc7_.toUpperCase(),this.getNextHighestDepth());
         if(_loc2_ == undefined)
         {
            _loc4_ = (this._mcBgFlags._width - _loc5_.length * _loc8_._width) / (_loc5_.length + 1);
            _loc2_ = this._mcBgFlags._x + _loc4_;
            _loc3_ = this._mcBgFlags._y + (this._mcBgFlags._height - _loc8_._height) / 2;
         }
         _loc8_._x = _loc2_;
         _loc8_._y = _loc3_;
         ...
         _loc9_ = this.attachMovie("UI_Login_flagsMask","_mcMask" + _loc7_.toUpperCase(),this.getNextHighestDepth());
         _loc9_._x = _loc2_;
         _loc9_._y = _loc3_;
   ...
   function initInput()
   {
      ...
      if(dofus.Constants.DEBUG)
      {
         ...
         _loc3_ = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.loginInfos;
         if(_loc3_ != undefined)
         {
   ...
   function fillCommunityID()
   {
      ...
      {
         _loc4_ = this.api.lang.getConfigText("DEFAULT_COMMUNITY");
         _loc5_ = _loc4_.split(",");
   ...
   function onAlertLoad(bSuccess)
   {
      ...
      if(bSuccess)
      {
         ...
         _loc4_ = String(this._xAlert.firstChild.attributes.ignoreVersion).split("|");
         this._bHideNext = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.lastAlertID == this._sAlertID;
         if(!this._bHideNext)
         {
            _loc5_ = dofus.Constants.VERSION + "." + dofus.Constants.SUBVERSION + "." + dofus.Constants.SUBSUBVERSION;
            _loc6_ = true;
            _loc7_ = 0;
   ...
   function itemSelected(oEvent)
   {
      ...
      switch(oEvent.target._name)
      {
         case "_cbPorts":
            ...
            break;
         case "_lstNews":
            _loc4_ = ank.utils.rss.RSSItem(oEvent.row.item);
   ...
   function onLogin(sLogin, sPassword, bZaapConnect)
   {
      ...
      if(!bZaapConnect)
      {
         if(dofus.Constants.DEBUG)
         {
            _loc5_ = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
      ...
      {
         _loc6_ = this.api.lang.getConfigText("SERVER_NAME");
      ...
      {
         _loc10_ = this.api.lang.getText("NO_SERVER_ADDRESS");
      ...
      switch(oEvent.target._name)
      {
         ...
         case "_mcSubscribe":
            ...
            if(this.api.lang.getConfigText("REGISTER_INGAME"))
            {
               ...
               _loc3_ = this.gapi.loadUIComponent("Register","Register");
               _loc4_ = dofus.graphics.gapi.ui.Register(_loc3_);
               _loc4_.addEventListener("close",this);
               return;
            }
            if(this.api.config.isStreaming)
         ...
         case "_btnServersState":
            _loc6_ = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
         ...
         default:
            ...
            {
               _loc7_ = String(oEvent.target._name).substr(7,2).toLowerCase();
               if(this.api.config.isStreaming)
               {
            ...
            {
               _loc8_ = oEvent.target.params.url;
   ...
   function onGifts(oLoadVars, bSuccess)
   {
      ...
      {
         _loc5_ = this.createEmptyMovieClip("_mcMaskGift",this.getNextHighestDepth());
         with(_loc5_)
         {
            beginFill(0,100);
            moveTo(43,400);
         ...
         while(_loc6_ <= _loc4_)
         {
            _loc7_ = ank.gapi.controls.Button(this._mcGifts.attachMovie("Button","btn" + _loc6_,_loc6_,{_x:(_loc6_ - 1) * 131,_width:110,_height:92,backgroundDown:"ButtonTransparentUp",backgroundUp:"ButtonTransparentUp",styleName:"none"}));
            ...
            _loc8_ = ank.gapi.controls.Loader(this._mcGifts.attachMovie("GAPILoader","ldr" + _loc6_,_loc6_ + 100,{_x:(_loc6_ - 1) * 131,_width:110,_height:92}));
   ...
   function onEnterFrame()
   {
      ...
      {
         _loc2_ = 742 / 2 - this._xmouse;
         if(Math.abs(_loc2_) > 300)
         {
            _loc3_ = this._mcGifts._x + _loc2_ / 40;
            if(_loc2_ > 0)
            {
               if(_loc3_ > 55)
               {
   ...
   function over(oEvent)
   {
      ...
      switch(oEvent.target._name)
      {
         ...
         default:
            if(String(oEvent.target._name).substring(0,7) == "_mcFlag")
            {
               _loc3_ = String(oEvent.target._name).substr(7,2);
               _loc4_ = this.api.lang.getText("LANGUAGE_" + _loc3_);
   ...
   function onData()
   {
      ...
      {
         _loc4_ = this._siServerStatus.problems[_loc3_];
         _loc2_ += _loc4_.date + "\n";
