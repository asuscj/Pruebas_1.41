class dofus.graphics.gapi.controls.Smileys extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function attachSmileys()
   {
      ...
      while(_loc7_ <= 15)
      {
         _loc8_ = this._ldrStreaming.content.attachMovie(String(_loc7_),"smiley" + _loc7_,_loc7_);
         if(_loc8_._width > _loc8_._height)
         {
            _loc6_ = _loc8_._height / _loc8_._width;
   ...
   function overItem(oEvent)
   {
      ...
      if(_loc3_ != undefined)
      {
         _loc4_ = this.api.lang.getEmoteText(_loc3_.index);
         _loc5_ = _loc4_.n;
         _loc6_ = _loc4_.s == undefined ? "" : " (/" + _loc4_.s + ")";
