class dofus.graphics.gapi.controls.FightChallengeViewer extends ank.gapi.core.UIAdvancedComponent
{
   ...
   function initText()
   {
      ...
      {
         _loc4_ = _loc2_.datacenter.Sprites.getItemAt(this.challenge.targetId).name + " (" + _loc2_.lang.getText("LEVEL_SMALL") + " " + _loc2_.datacenter.Sprites.getItemAt(this.challenge.targetId).mc.data.Level + ")";
