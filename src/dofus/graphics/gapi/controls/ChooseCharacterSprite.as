class dofus.graphics.gapi.controls.ChooseCharacterSprite extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set isDead(bIsDead)
   {
      ...
      if(this._isDead)
      {
         _loc3_ = {ra:dofus.graphics.gapi.controls.ChooseCharacterSprite.DEATH_ALPHA,rb:100,ga:dofus.graphics.gapi.controls.ChooseCharacterSprite.DEATH_ALPHA,gb:100,ba:dofus.graphics.gapi.controls.ChooseCharacterSprite.DEATH_ALPHA,bb:100};
      }
      else
      {
   ...
   function onKeyUp()
   {
      ...
      if(this._bSelected)
      {
         _loc2_ = Number(String.fromCharCode(Key.getCode()));
