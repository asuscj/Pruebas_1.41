class dofus.graphics.gapi.controls.Helper extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   static function getCurrentHelper()
   {
      ...
      {
         _loc2_ = _global.API.ui.getUIComponent("Banner");
         if(_loc2_ == undefined)
         {
            return null;
         }
         _loc3_ = _loc2_.circleXtra.showCircleXtra("helper",true,{bMask:true});
   ...
   function playNextAnimation()
   {
      ...
      {
         _loc2_ = String(this._aAnimationQueue.shift());
      ...
      else
      {
         ...
         {
            _loc3_ = _global.API.ui.getUIComponent("Banner");
