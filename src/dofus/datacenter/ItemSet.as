class dofus.datacenter.ItemSet extends Object
{
   ...
   function setItems(aItemIDs)
   {
      ...
      {
         _loc6_ = Number(_loc3_[_loc5_]);
         if(!_global.isNaN(_loc6_))
         {
            if(_loc6_ < dofus.datacenter.evenemential.ItemUpgrader.UPGRADE_MULTIPLICATOR)
            {
               _loc7_ = new dofus.datacenter.Item(0,_loc6_,1);
               _loc8_ = _loc4_[_loc6_] == true || (_loc4_[_loc6_ + dofus.datacenter.evenemential.ItemUpgrader.UPGRADE_MULTIPLICATOR] == true || _loc4_[_loc6_ + 2 * dofus.datacenter.evenemential.ItemUpgrader.UPGRADE_MULTIPLICATOR] == true);
