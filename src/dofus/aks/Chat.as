   ...
   function onMessage(bSuccess, sExtraData)
   {
      ...
      switch(_loc4_)
      {
         ...
         case "#":
            ...
            {
               _loc12_ = "WHISP_CHAT";
               _loc15_ = this.isLivingItemMessage(_loc6_);
               if(!_loc15_)
               {
                  if(this.api.datacenter.Game.isSpectator)
                  {
                     _loc16_ = "(" + this.api.lang.getText("SPECTATOR") + ")";
                  }
                  else
                  {
               ...
               if(_loc15_ && !_global.isNaN(_loc6_.substr(2,_loc6_.length - 4)))
               {
         ...
         case "%":
            ...
            _loc18_ = "(" + this.api.lang.getText("GUILD") + ") " + _loc7_ + " : ";
         ...
         case "$":
            _loc12_ = "PARTY_CHAT";
            _loc19_ = "(" + this.api.lang.getText("PARTY") + ") " + _loc7_ + " : ";
         ...
         case "!":
            _loc12_ = "PVP_CHAT";
            _loc20_ = "(" + this.api.lang.getText("ALIGNMENT") + ") " + _loc7_ + " : ";
         ...
         case "?":
            ...
            _loc21_ = "(" + this.api.lang.getText("RECRUITMENT") + ") " + _loc7_ + " : ";
         ...
         case ":":
            _loc12_ = "TRADE_CHAT";
            _loc22_ = "(" + this.api.lang.getText("TRADE") + ") " + _loc7_ + " : ";
         ...
         case "^":
            _loc12_ = "MEETIC_CHAT";
            _loc23_ = "(" + this.api.lang.getText("MEETIC") + ") " + _loc7_ + " : ";
         ...
         case "e":
            ...
            _loc24_ = _loc10_.split(";");
            _loc6_ = "EVENT_" + String(_loc24_[0]) + "," + _loc24_[1];
            break;
         case "@":
            _loc12_ = "ADMIN_CHAT";
            _loc25_ = "(" + this.api.lang.getText("PRIVATE_CHANNEL") + ") " + _loc7_ + " : ";
            ...
            break;
         default:
            _loc26_ = this.isLivingItemMessage(_loc6_);
            if(this.api.lang.getConfigText("EMOTES_ENABLED") && (!_loc26_ && (_loc6_.charAt(0) == dofus.Constants.EMOTE_CHAR && _loc6_.charAt(_loc6_.length - 1) == dofus.Constants.EMOTE_CHAR)))
            {
               ...
               {
                  _loc27_ = !(_loc6_.charAt(_loc6_.length - 2) == "." && _loc6_.charAt(_loc6_.length - 3) != ".") ? _loc6_ : _loc6_.substr(0,_loc6_.length - 2) + dofus.Constants.EMOTE_CHAR;
            ...
            if(_loc6_.substr(0,7) == "!THINK!")
            {
               ...
               _loc12_ = "THINK_CHAT";
               _loc28_ = _loc7_ + " " + this.api.lang.getText("THINKS_WORD") + " : ";
            ...
            {
               _loc30_ = this.api.kernel.DebugManager.getTimestamp();
