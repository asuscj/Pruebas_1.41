class dofus.aks.Conquest extends dofus.aks.Handler
{
   ...
   function onWorldData(sExtraData)
   {
      ...
      for(var i in _loc6_)
      {
         _loc7_ = String(_loc6_[i]).split(",");
         if(_loc7_.length >= 5)
         {
            _loc8_ = new dofus.datacenter.ConquestZoneData(Number(_loc7_[0]),Number(_loc7_[1]),Number(_loc7_[2]) == 1,Number(_loc7_[3]),Number(_loc7_[4]) == 1);
      ...
      {
         _loc11_ = String(_loc10_[i]).split(",");
         if(_loc11_.length == 4)
         {
            _loc12_ = new dofus.datacenter.ConquestVillageData(Number(_loc11_[0]),Number(_loc11_[1]),Number(_loc11_[2]) == 1,Number(_loc11_[3]) == 1);
   ...
   function onPrismFightAddPlayer(sExtraData)
   {
      ...
      while(_loc6_ < _loc4_.length)
      {
         ...
         if(_loc3_)
         {
            ...
            _loc9_ = this.api.datacenter.Conquest.players.findFirstItem("id",_loc8_.id);
            if(_loc9_.index != -1)
            {
         ...
         {
            _loc10_ = _global.parseInt(_loc7_[0],36);
            _loc11_ = this.api.datacenter.Conquest.players.findFirstItem("id",_loc10_);
            if(_loc11_.index != -1)
            {
   ...
   function onPrismFightAddEnemy(sExtraData)
   {
      ...
      while(_loc7_ < _loc4_.length)
      {
         ...
         if(_loc3_)
         {
            ...
            _loc10_ = _loc6_.findFirstItem("id",_loc9_.id);
            if(_loc10_.index != -1)
            {
         ...
         {
            _loc11_ = _global.parseInt(_loc8_[0],36);
            _loc12_ = _loc6_.findFirstItem("id",_loc11_);
            if(_loc12_.index != -1)
            {
