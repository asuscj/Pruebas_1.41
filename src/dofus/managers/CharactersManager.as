   ...
   function setSpriteAccessories(oSprite, sAccessories)
   {
      ...
      if(sAccessories.length != 0)
      {
         ...
         while(_loc6_ < _loc5_.length)
         {
            ...
            {
               _loc10_ = _loc5_[_loc6_].split("~");
               _loc7_ = _global.parseInt(_loc10_[0],16);
               _loc9_ = _global.parseInt(_loc10_[1]);
               _loc8_ = _global.parseInt(_loc10_[2]) - 1;
               if(_loc8_ < 0)
               {
                  _loc8_ = 0;
               }
            ...
            {
               _loc11_ = new dofus.datacenter.Accessory(_loc7_,_loc9_,_loc8_);
