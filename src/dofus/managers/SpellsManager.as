class dofus.managers.SpellsManager
{
   ...
   function nextTurn()
   {
      ...
      {
         _loc2_ = this._aSpellsDelay[_loc3_];
   ...
   function checkCanLaunchSpellReturnObject(nSpellID, nSpriteOnID)
   {
      ...
      {
         _loc5_ = this._aSpellsCountByPlayer[_loc11_];
         _loc6_ = _loc5_.spell;
         if(_loc6_.ID == nSpellID)
         {
            _loc8_ = _loc6_.launchCountByPlayerTurn;
      ...
      {
         _loc12_ = _loc9_.requiredStates;
         _loc13_ = _loc9_.forbiddenStates;
         _loc14_ = 0;
      ...
      {
         _loc16_ = this.api.datacenter.Player.data.CharacteristicsManager.getModeratorValue(dofus.managers.CharacteristicsManager.MAX_SUMMONED_CREATURES_BOOST) + this.api.datacenter.Player.MaxSummonedCreatures;
      ...
      while((_loc11_ = _loc11_ - 1) >= 0)
      {
         ...
         if(_loc6_.ID == nSpellID)
         {
            _loc7_ = _loc6_.launchCountByTurn;
