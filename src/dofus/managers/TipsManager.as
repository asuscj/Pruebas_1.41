class dofus.managers.TipsManager extends ank.utils.QueueEmbedMovieClip
{
   ...
   function showNewTip(nTip)
   {
      ...
      {
         _loc3_ = dofus.graphics.gapi.controls.Helper.getCurrentHelper();
         if(_loc3_ == null)
         {
            return undefined;
         }
   ...
   function pointSprite(nMapID, nGfxID)
   {
      ...
      for(var k in _loc4_)
      {
         ...
         {
            _loc5_ = {x:_loc4_[k].mc._x,y:_loc4_[k].mc._y};
            _loc4_[k].localToGlobal(_loc5_);
            _loc6_ = _loc5_.x;
            _loc7_ = _loc5_.y;
            _loc8_ = _loc4_[k].mc._height;
   ...
   function loadTipsStates()
   {
      ...
      {
         _loc2_ = this.getTipsSharedObject();
